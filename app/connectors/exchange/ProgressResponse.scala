...
object ProgressResponse {
  ...
  implicit val phase1ProgressResponseFormat: OFormat[Phase1ProgressResponse] =
    Json.format[Phase1ProgressResponse]
  implicit val phase2ProgressResponseFormat: OFormat[Phase2ProgressResponse] =
    Json.format[Phase2ProgressResponse]
  implicit val phase3ProgressResponseFormat: OFormat[Phase3ProgressResponse] =
    Json.format[Phase3ProgressResponse]
  implicit val siftProgressResponseFormat: OFormat[SiftProgressResponse] = Json.format[SiftProgressResponse]
